...
2. Per-rung ladder logging has landed in the repo (ForegroundActivator.TryActivate); after the next failing occurrence, the log will state exactly which rung claimed success. Redeploy first.
